...
@RestController
@RequestMapping("/api/panda-fit-kafka")
public class PandaFitKafkaResource {

    private final Logger log = LoggerFactory.getLogger(PandaFitKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public PandaFitKafkaResource(KafkaProperties kafkaProperties) {
